...
import org.exoplatform.custom.forgotpassword.PasswordRecoveryHandler;
import org.exoplatform.custom.forgotpassword.PasswordRecoveryService;
...
public class PasswordRecoveryServiceImpl implements PasswordRecoveryService {
    ...
    private String buildEmailBody(User user, ResourceBundle bundle, String link) {
        String content;
        InputStream input = this.getClass().getClassLoader().getResourceAsStream("conf/forgot_password_email.html");
        if (input == null) {
            content = "";
        } else {
